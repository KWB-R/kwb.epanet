if (FALSE)
{
  ...
  list(
    ...
    BACKDROP = list(  
      DIMENSIONS = MODES$character, # numeric vector of length 4 
      UNITS      = MODES$character,
      FILE       = MODES$character,           	
      OFFSET     = MODES$character  # numeric vector of length 2
    )
  )
  
  # table-like sections (with header row) ----------------------------------------
  ...
  list(
    ...
    PATTERNS = list(
      ID= MODES$character,
      Multipliers = MODES$character # numeric vector of variable length
    ),
    STATUS = list(
      "ID"             = MODES$character,
    ...
    SOURCES = list(
      Node    = MODES$character,
      Type    = MODES$character,
      Quality = MODES$numeric, # EPAENT Tooklit Reference says "Strength"
      Pattern = MODES$character
    ),
    MIXING = list(
